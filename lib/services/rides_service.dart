...
class RidesService {
  ...
  static List<Ride> filterBy({Location? departure, int? seatRequested}) {
    ...
    if (departure != null) filteredRides = _filterByDeparture(filteredRides, departure);

    if (seatRequested != null) filteredRides = _filterBySeatRequested(filteredRides, seatRequested);
